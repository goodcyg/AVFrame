...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
    ...
    /**
     * The method to parse rtp jpeg packet
     * ORIGIN: The original method
     * DROP: Drop packet drop frame
     * FILL: Drop packet fill packet
     * The default parse method is FILL
     */
    int rtp_jpeg_parse_packet_method;
#define RTP_JPEG_PARSE_PACKET_METHOD_ORIGIN	0
#define RTP_JPEG_PARSE_PACKET_METHOD_DROP	1
#define RTP_JPEG_PARSE_PACKET_METHOD_FILL	2

    /**
       Required by RTCP SR Data send back to APP Layer
       return value: UNDEFINED
     */
    struct RTCP_SR_CB {
        int (*callback)(void *opaque, uint8_t *buf, int len);
        void *opaque;
    } rtcp_sr_cb;
} AVFormatContext;
