...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=mpeg4 --enable-encoder=aac --disable-decoders --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=h264 --enable-decoder=pcm_s16le --enable-decoder=aac --enable-decoder=aac_latm --disable-muxers --enable-muxer=image2 --enable-muxer=mov --enable-muxer=mjpeg --enable-muxer=avi --enable-muxer=h264 --enable-muxer=mp4 --disable-demuxers --enable-demuxer=rtsp --enable-demuxer=mjpeg --enable-demuxer=avi --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=pcm_s16le --enable-demuxer=aac --disable-parsers --enable-parser=mjpeg --enable-parser=mpeg4video --enable-parser=h264 --enable-parser=aac --enable-parser=aac_latm --disable-bsfs --disable-protocols --enable-protocol=async --enable-protocol=file --enable-protocol=udp --enable-protocol=tcp --enable-protocol=rtp --enable-protocol=rtmp --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --disable-debug --enable-small --prefix=/Users/Jackson/Desktop/best/ijkplayer_library_source/ijkplayer/ios/build/ffmpeg-arm64/output --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/Jackson/Desktop/best/ijkplayer_library_source/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/Jackson/Desktop/best/ijkplayer_library_source/ijkplayer/ios/build/ffmpeg-arm64/output/share/ffmpeg"
